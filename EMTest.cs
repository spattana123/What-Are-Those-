...
public class EMTest : MonoBehaviour {
    ...
    private const string apilink = "https://pndpc1zj3a.execute-api.us-east-1.amazonaws.com/productionG/";
    ...
    void Start()
    {
        ...
        buttonObject2 = GameObject.Find("Button2");
    }
...
/*
 ...
 /*       dbcmd.CommandText = sqlQuery2;
        ...
        buttonObject2.gameObject.SetActive(true);
    ...
    public float[] parseVectors(string vector)
    {
        List<float> floatlist = new List<float>();
        char[] vectorchararray = vector.ToCharArray();
        int leftind = 0;
        int rightind = 0;
        string floatval = "";
        float val = 0.0f;
        for(int i=0; i < vectorchararray.Length; i++)
        {
            ...
            {
                rightind = i;
                floatval = vector.Substring(leftind, rightind);
                val = float.Parse(floatval);
                floatlist.Add(val);
            }
        }
    ...
    IEnumerator Radar()
    {
        ...
        print("GOOGLE "+googleRespStr);
    }

    public IEnumerator testAzure()
    {
        string AZURE_URL = "https://soumyapattanayakhelloworld.azurewebsites.net/api/HttpTriggerCSharp1?code=ZXRiC3l9Z8o3DER4ppeMOGtsqa4sGU4gC8dXE7ZZV4FLLw6iuamFkA==&name=Soumya";
        WWW azureResp = new WWW(AZURE_URL);
        yield return azureResp;
        string azureRespStr = azureResp.text;
        print(azureRespStr);
    }
